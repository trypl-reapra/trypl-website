...
export const site = {
  ...
  description:
    "TrypL（トリプル）は、REAPRA発の若年層向けインターンシップコミュニティ。社会とつながり、やりながら学ぶ。REAPRAおよび投資先企業でのインターンを通じて、内発的動機から「社会と共創する熟達」への一歩を踏み出す場です。",
  // 連絡先。
...
export const defaultPress = [
  {
    ...
    body:
      "このたび、REAPRA発の若年層向けインターンシップコミュニティ「TrypL（トリプル）」の公式サイトを公開しました。\n\n" +
