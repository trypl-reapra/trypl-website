 ...
 * ───────────────────────────────────────────────────────────
 * ⚠️ これらは「募集要項の例」です。
 *    企業名（company）と業種（companyTag）は REAPRA Japan の実在の
 *    投資先企業（https://jp.reapra.com/investment/ 掲載）を参照していますが、
 *    職務内容・条件・待遇は TrypL が作成したサンプルで、各社の公式募集
 *    ではありません。実際に募集する際は各社と調整のうえ差し替え、
