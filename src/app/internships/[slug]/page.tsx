...
function mapAdmin(a: AdminInternship): Internship {
  return {
    slug: `admin-${a.id}`,
    company: a.company,
    companyTag: a.companyTag || "インターン募集",
    title: a.title,
...
async function resolveInternship(slug: string): Promise<Internship | null> {
  ...
  return ov
    ? {
        ...
        companyTag: ov.companyTag ?? base.companyTag,
        title: ov.title ?? base.title,
        location: ov.location ?? base.location,
        workStyle: ov.workStyle ? asWorkStyle(ov.workStyle) : base.workStyle,
        commitment: ov.commitment ?? base.commitment,
        duration: ov.duration ?? base.duration,
        compensation: ov.compensation ?? base.compensation,
        summary: ov.summary ?? base.summary,
        about: ov.about ?? base.about,
        responsibilities: ov.responsibilities ?? base.responsibilities,
        requirements: ov.requirements ?? base.requirements,
        ...
        headerImage: ov.headerImage ?? base.headerImage,
      }
    : base;
}
